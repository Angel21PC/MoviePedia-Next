            ...
            <div className="registration-form">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group">
                        <input type="text" className="form-control item" key="username" id="username" placeholder="Username" name="username" {...register('username')} />
                    ...
                    <div className="form-group">
                        <input type="password" className="form-control item" key="password2" id="password2" placeholder="Password again pls" name="password2" {...register('password2')}  pattern='^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$ %^&*-]).{8,}$' />
                    ...
                    <div className="form-group">
                        <input type="text" className="form-control item" key="phone_number" id="phone_number" name="phone_number" {...register('phone_number')}  placeholder="Phone Number (if you want)"   />
                        {errors.phone_number?.message && <p>{errors.phone_number?.message}</p>}
                    </div>
                    <div className="form-group">
                        <input type="date" className="form-control item" key="birth_date" id="birth_date" name="birth_date" {...register('birth_date')}  placeholder="Birth Date"  />
